...
2a)Hangi yontem daha  kullanisli?
   Genellikle Runnable interface ini implements ederek olusturmak daha cok tercih edilir.
   Cunku Java da sadece bir class extends edebiliriz bu hakkimizi Thread ile harcamak istemeyiz
